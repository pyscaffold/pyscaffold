...
# built documents.
# The following are default values, that are rewritten later in the script.
#
...
try:
    from pyscaffold import __version__ as package_version
    if package_version.lower() != 'unknown':
