...
The main advantage of conda compared to virtual-env based tools is that it unifies
...
Python version and even system libraries like glibc. In the pip ecosystem, one
...
2. Create an environment based on this file with::
   ...
   Mamba_ is a new, much faster drop-in replacemenet for conda_. For large environments,
